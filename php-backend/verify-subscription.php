<?php
/**
 * Razorpay PHP Backend - Verify Subscription
 * 
 * This file verifies the subscription payment signature
 */
...
// Validate input
if (!isset($input['razorpay_subscription_id']) || 
